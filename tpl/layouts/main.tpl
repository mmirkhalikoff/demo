		...
		<div class="section-inner">
			...
			<div class="horizontal-text container">
					<div class="name-creator">
						<p class="creator">Mirjalol Mirkhalikov </p>
					</div>
...
<!------------------ Contact start ------------------->
	...
	<footer>
		<section id="contact" class="section-seven">
            <div class="section-inner container">
				...
				<div class="block-ru">
                    <div class="text">
                        <p class="heading-text">Обо мне</p>
                        <p class="footer-text">Здравствуйте все! Я Mirjalol Mirkhalikov,
                            Мне 21 лет. Это сайт мое портфолио,
                            и вы можете познакомиться с моей карьерой.</p>
                    </div>
                </div>
	...
	<script src="scripts/menu-toggle-animation.js"></script>
	<script src="scripts/scroll-menu-animate.js"></script>
	<!-- endbuild -->
